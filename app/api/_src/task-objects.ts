...
// TODO: for later if we decide to implement
// class Subtask {
...
export class Task extends DB_Object {
  ...
  constructor(objectOrId: any | string, user_id: string, name?: string, category?: string, description?: string, 
...
export class TaskResponse {
  ...
  constructor(paramOrStatus: any | number, statusText?: string, task_id?: string) {
