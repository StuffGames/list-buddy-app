...
const [user, setUser] = useState({
  name: 'John Doe',
  profilePicture:
    <div className=" right-0 transform translate-x-1/4 translate-y-[150px] scale-25 overflow-hidden">
      <svg width="681" height="1077" viewBox="0 0 681 1077" fill="none" xmlns="http://www.w3.org/2000/svg">
