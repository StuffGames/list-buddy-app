...
export default function TaskView({ task }) {
  ...
  return (
      ...
      <div className= {`p-5 ${color[0]} text-white rounded-xl h-full relative`}>
          ...
          <p className="mt-4 text-sm font-bold">Complete by: {task.deadline.toLocaleDateString()}</p>
          ...
          <svg width="36" height="30" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M22.017 25.2995C19.8573 20.2021 15.7977 16.1426 10.7003 13.9828C15.7977 11.8231 19.8573 7.76352 22.017 2.66616C24.1768 7.76352 28.2363 11.8231 33.3337 13.9828C28.2363 16.1426 24.1768 20.2021 22.017 25.2995Z" stroke="white" strokeWidth="4" stroke-linejoin="round"/>
